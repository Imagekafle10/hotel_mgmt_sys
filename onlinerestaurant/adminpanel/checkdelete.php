               ...
               <th>TotalPrice</th>
                ...
                <tr>
                    <form action="" method="post">
                        ...
                        <td> <input type="text" name="In" value="<?php echo $_GET['in']; ?>"> </td>
                            <td>
                        ...
                        <td> <input type="text" name="Out" value="<?php echo $_GET['out']; ?>"> </td>
                        <td> <input type="text" name="Price" value="<?php echo $_GET['room']; ?>"> </td>
                    </tr>
                </table>
            </div>
        </div>
...
$conn=mysqli_connect("localhost","root","","hotelmgmtsys");
$name=$_GET['name'];
$query="DELETE from checkinout where Name='$name' ";
$data=mysqli_query($conn,$query);
if($data){
     echo"<script>window.location.href='panel.php';</script>"; 
}else{
